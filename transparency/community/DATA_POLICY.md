...
Submission interfaces may accept optional contact fields for transient handling,
but those values are not persisted in the feature-request dataset covered by
this policy.
...
Wallet addresses may be screened against publicly maintained sanctions lists (e.g.,
OFAC SDN list) at the product interface layer before certain off-chain operations
such as API key issuance or transaction relay.
...
No sanctions-screening results are persisted in the feature-request dataset covered
by this policy.
