...
pub struct AutomatedInterestTransferRemainingAccounts {
    pub accounts: [TridentAccount; 4],
}

#[derive(TridentInstruction, Default)]
#[program_id("278CdXnmeUFSmNjwbmRQmHk87fP5XqGmtshk9Jwp8VdE")]
#[discriminator([162u8, 116u8, 84u8, 9u8, 231u8, 251u8, 89u8, 235u8])]
pub struct AutomatedInterestTransferInstruction {
    pub accounts: AutomatedInterestTransferInstructionAccounts,
    pub remaining_accounts: AutomatedInterestTransferRemainingAccounts,
    pub data: AutomatedInterestTransferInstructionData,
}

/// Instruction Accounts
#[derive(Debug, Clone, TridentAccounts, Default)]
#[instruction_data(AutomatedInterestTransferInstructionData)]
#[storage(FuzzAccounts)]
pub struct AutomatedInterestTransferInstructionAccounts {
    #[account(mut)]
...
pub struct AutomatedInterestTransferInstructionData {}
...
impl InstructionHooks for AutomatedInterestTransferInstruction {
