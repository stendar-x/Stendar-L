...
#[discriminator([178u8, 123u8, 94u8, 47u8, 234u8, 153u8, 89u8, 45u8])]
pub struct ProcessPoolWithdrawalInstruction {
    pub accounts: ProcessPoolWithdrawalInstructionAccounts,
    pub data: ProcessPoolWithdrawalInstructionData,
}

/// Instruction Accounts
#[derive(Debug, Clone, TridentAccounts, Default)]
#[instruction_data(ProcessPoolWithdrawalInstructionData)]
#[storage(FuzzAccounts)]
pub struct ProcessPoolWithdrawalInstructionAccounts {
    #[account(signer)]
    pub processor: TridentAccount,
...
pub struct ProcessPoolWithdrawalInstructionData {}
...
impl InstructionHooks for ProcessPoolWithdrawalInstruction {
    ...
    fn set_accounts(&mut self, trident: &mut Trident, fuzz_accounts: &mut Self::IxAccounts) {
        ...
        let processor = fuzz_accounts.operator.get_or_create(0, trident, None, None);
        ...
        self.accounts.processor.set_address(processor);
