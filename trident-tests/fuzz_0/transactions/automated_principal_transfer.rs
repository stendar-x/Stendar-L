...
pub struct AutomatedPrincipalTransferTransaction {
    pub instruction: AutomatedPrincipalTransferInstruction,
}
...
impl TransactionHooks for AutomatedPrincipalTransferTransaction {
