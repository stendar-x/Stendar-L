...
pub struct MakePaymentWithDistributionTransaction {
    pub instruction: MakePaymentWithDistributionInstruction,
}
...
impl TransactionHooks for MakePaymentWithDistributionTransaction {
