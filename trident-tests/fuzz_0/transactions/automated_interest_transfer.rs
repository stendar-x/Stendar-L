...
pub struct AutomatedInterestTransferTransaction {
    pub instruction: AutomatedInterestTransferInstruction,
}
...
impl TransactionHooks for AutomatedInterestTransferTransaction {
