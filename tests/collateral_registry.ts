...
import { airdropSol, asTestProgram, refundTrackedKeypairs, toBn } from "./test_helpers.ts";
import { PYTH_RECEIVER_PROGRAM_ID } from "./mock_oracle_utils.ts";
  ...
  async function upsertMockOraclePriceFeed(
    ...
    if (accountInfo === null) {
      await program.methods
        ...
        .rpc();
    } else if (typeof program.methods.setMockOraclePriceFeed === "function") {
      await program.methods
