...
import type { ParseAccountOptions, ParsedContributionAccount } from './types';
...
export function parseContributionAccount(data: Buffer, options?: ParseAccountOptions): ParsedContributionAccount | null {
  ...
  try {
    ...
    return handleParserError('LenderContribution', error, options);
  }
}
