...
#[test]
fn mvp_secondary_market_rejects_partial_position_listings() {
...
fn governance_rotation_requires_current_authority() {
    ...
    let result = treasury.set_authority(unauthorized_signer, Pubkey::new_unique(), 1_700_000_100);
...
fn governance_rotation_allows_valid_authority_and_bot_updates() {
    ...
    let authority_update_result = treasury.set_authority(authority, new_authority, 1_700_000_100);
