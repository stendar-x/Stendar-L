use super::lending::{calculate_recall_fee, with_test_clock_offset};
use crate::contexts::*;
use crate::errors::StendarError;
use crate::state::{
    ContractStatus, DebtContract, InterestPaymentType, LenderContribution, LoanType,
    PaymentFrequency, PrincipalPaymentType, ProposalStatus, ProposerCooldown,
    TermAmendmentProposal, VoteChoice, CURRENT_ACCOUNT_VERSION, PROPOSAL_COOLDOWN_SECONDS,
    PROPOSAL_EXPIRY_SECONDS, RECALL_GRACE_PERIOD_SECONDS,
};
use crate::utils::{
