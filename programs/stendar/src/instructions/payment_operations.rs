...
/// Integer rounding remainder is deterministically assigned to the last lender in
/// the iteration order, guaranteeing the full `total_payment` is always distributed.
