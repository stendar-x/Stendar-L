...
use crate::utils::{
    ...
    safe_u128_to_u64, HealthStatus, MAX_CONFIDENCE_BPS_LIQUIDATION,
    MAX_CONFIDENCE_BPS_STANDARD, MAX_LENDERS_PER_TX, MAX_PRICE_AGE_CREATION,
...
pub fn create_debt_contract(
    ...
    if let Some(frontend_operator) = ctx.accounts.frontend_operator.as_ref() {
        contract.set_frontend(frontend_operator.operator);
    }
