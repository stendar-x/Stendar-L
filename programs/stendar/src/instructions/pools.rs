...
fn accrue_deposit_yield(
    ...
    if accrued > 0 {
        ...
        if capped_accrued == 0 {
            // Keep last_yield_update unchanged when liquidity cannot currently back yield.
            // This allows deferred accrual to be retried when capacity returns.
            return Ok(0);
        }
...
mod tests {
    ...
    #[test]
    fn accrue_deposit_yield_uses_current_rate_without_history() {
