...
#[cfg(feature = "mainnet")]
pub const MAX_PRICE_AGE_CREATION: u64 = 60;
...
mod tests {
    ...
    #[test]
    fn default_feature_staleness_constants_match_expected_values() {
        assert_eq!(MAX_PRICE_AGE_CREATION, 120);
        assert_eq!(MAX_PRICE_AGE_DRAW, MAX_PRICE_AGE_CREATION);
        assert_eq!(MAX_PRICE_AGE_LIQUIDATION, 60);
    }
