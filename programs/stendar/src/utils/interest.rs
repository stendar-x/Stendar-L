...
mod tests {
    ...
    fn recall_debt_share_matches_proportional_formula() {
        let debt_share = calculate_recall_debt_share(300_000, 1_000_000, 400_000, true)
    ...
    fn recall_debt_share_proportional_after_partial_payment() {
        let debt_share = calculate_recall_debt_share(300_000, 1_000_000, 400_000, false)
    ...
    fn recall_debt_share_zero_when_outstanding_is_zero() {
        let debt_share = calculate_recall_debt_share(0, 1_000_000, 400_000, false)
    ...
    fn recall_debt_share_full_outstanding_equals_contribution() {
        let debt_share = calculate_recall_debt_share(1_000_000, 1_000_000, 400_000, false)
    ...
    fn revolving_recall_split_keeps_total_principal_conserved() {
        ...
        let debt_share = calculate_recall_debt_share(300_000, 1_000_000, recall_amount, true)
            .expect("debt share should compute");
