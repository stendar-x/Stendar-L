...
pub use utils::{
    ...
    process_automatic_interest, process_scheduled_principal_payments, HealthStatus,
    MIN_PLATFORM_FEE, TX_FEE_ESTIMATE,
};
...
pub mod stendar {
    ...
    pub fn register_frontend(ctx: Context<RegisterFrontend>) -> Result<()> {
        instructions::register_frontend(ctx)
    }
