...
pub const TRADE_LISTING_SEED: &[u8] = b"listing";
pub const TRADE_OFFER_SEED: &[u8] = b"offer";
pub const TRADE_EVENT_SEED: &[u8] = b"trade";
pub const TRADE_TRANSFER_EVENT_SEED: &[u8] = b"transfer";
